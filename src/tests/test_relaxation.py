...
def test_heuristics():
    ...
    for (task, expected_hAdd, expected_hMax, expected_hSA, expected_hFF) in expected:
...
def test_hMax_blocksworld_complete_astar():
    ...
    ), hMaxHeuristic, true_h_values, plan_length
...
def test_hAdd_blocksworld_complete_astar():
    ...
    yield py.test.mark.slow(
        gen_blocks_test_astar
    ), hAddHeuristic, true_h_values, plan_length
...
def test_hSA_blocksworld_complete_astar():
    ...
    yield py.test.mark.slow(
        gen_blocks_test_astar
    ), hSAHeuristic, true_h_values, plan_length
...
def test_hFF_blocksworld_complete_astar():
    ...
    yield py.test.mark.slow(
        gen_blocks_test_astar
    ), hFFHeuristic, true_h_values, plan_length
